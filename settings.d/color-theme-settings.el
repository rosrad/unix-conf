...
(custom-set-faces
 ...
 ;; '(mode-line ((t (:background "dark olive" :foreground "dark blue" :box (:line-width -1 :color "gray75") :weight bold))))
 ;; '(mode-line-buffer-id ((t (:background "dark olive" :foreground "beige"))))
 ;; '(mode-line-highlight ((((class color) (min-colors 88)) nil)))
 ;; '(mode-line-inactive ((t (:background "dark olive" :foreground "dark khaki" :weight light))))
